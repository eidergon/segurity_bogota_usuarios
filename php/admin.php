...
<body>
    ...
    <form action="" class="formulario usuarios" id="usuarios" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <label for="cc_usuario">usuario dime</label>
                <input type="text" name="usuario_dime" placeholder="Dime">

                <label for="clave_usuario">Clave de dime</label>
                <input type="text" name="clave_dime">
            </div>

            <div class="col-md-3">
                <label for="cc_usuario">usuario Peog</label>
                <input type="text" name="usuario_peog" placeholder="Peog">

                <label for="clave_usuario">Clave de peog</label>
                <input type="text" name="clave_peog">
            </div>
        </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST["cc_usuario"]) && isset($_POST["clave_usuario"]) && isset($_POST["usuario_poliedro"]) && isset($_POST["clave_poliedro"]) && isset($_POST["usuario_idvision"]) && isset($_POST["clave_idvision"]) && isset($_POST["usuario_crm"]) && isset($_POST["clave_crm"]) && isset($_POST["usuario_myapp"]) && isset($_POST["clave_myapp"]) && isset($_POST["usuario_agendamiento"]) && isset($_POST["clave_agendamiento"]) && isset($_POST["usuario_visor"]) && isset($_POST["clave_visor"]) && isset($_POST["usuario_notus"]) && isset($_POST["clave_notus"]) && isset($_POST["usuario_dime"]) && isset($_POST["clave_dime"]) && isset($_POST["usuario_peog"]) && isset($_POST["clave_peog"]) ) {
            ...
            $usuario_dime = $_POST["usuario_dime"];
            $clave_dime = $_POST["clave_dime"];
            $usuario_peog = $_POST["usuario_peog"];
            $clave_peog = $_POST["clave_peog"];

            $sql = "INSERT INTO Usuarios (usuario_onelock, contraseña_onelock, poliedro, contraseña_poliedro, id_vision, contraseña_idvision, crm, contraseña_crm, agendamiento, contraseña_agendamiento, visor, contraseña_visor, my_app, contraseña_myapp, notus, contraseña_notus, dime, contraseña_dime, peog, contraseña_peog) VALUES ('$cc_usuario', '$clave_usuario', '$usuario_poliedro' , '$clave_poliedro', '$usuario_idvision' , '$clave_idvision', '$usuario_crm' , '$clave_crm', '$usuario_agendamiento' , '$clave_agendamiento', '$usuario_visor' , '$clave_visor', '$usuario_myapp', '$clave_myapp', '$usuario_notus', '$clave_notus', '$usuario_dime', '$clave_dime', '$usuario_peog', '$clave_peog')";
        ...
        //actualizar clave de usuario onelock
        ...
        if (isset($_POST["usuario_asignar"]) && isset($_POST["aplicativos"]) && isset($_POST["clave_usuario_app"]) && isset($_POST["usuario_app"])) {
            ...
            } elseif ($aplicativo === "dime") {
                $columna = "contraseña_dime";
                $columna2 = "dime";
                $sql = "UPDATE Usuarios SET $columna2 = '$usuario_app',$columna = '$clave_usuario_app' WHERE usuario_onelock = '$usuario_asignar'";
            } elseif ($aplicativo === "peog") {
                $columna = "contraseña_peog";
                $columna2 = "peog";
                $sql = "UPDATE Usuarios SET $columna2 = '$usuario_app',$columna = '$clave_usuario_app' WHERE usuario_onelock = '$usuario_asignar'";
            }
